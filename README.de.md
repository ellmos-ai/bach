...
Stand 2026-07-13: Auf der OpenClaw-Releases-Seite bleibt `2026.6.11` die aktuelle Stable-Linie; das neueste sichtbare Prerelease ist jetzt `2026.7.1-beta.6`, veröffentlicht am 2026-07-13 um 01:38 UTC. Für BACH bleiben GPT-5.6-Support, `openclaw attach`, Telegram-Codex-Steering, exit-getriggerte Cron-Läufe, approval-geführtes Onboarding, ClawRouter-Modell-/Budgetsicht und Crash-Loop-Recovery relevant. Beta 6 vertieft besonders Prozess-lokale SecretRef-Sentinels, Token-Redaktion über Log-Chunks, begrenzte Provider-/Netzwerkantworten, Migrationen vor Readiness und belastbare Hard-Timeout-/Subagent-Abschlusszustände. Für BACH passen davon besonders privacy-sichere Credential-Grenzen und recovery-sichere Runtime-/Scheduler-Oberflächen. Quelle: [openclaw/openclaw releases](https://github.com/openclaw/openclaw/releases/tag/v2026.7.1-beta.6).

Auf BACH-Seite hat der Daily-Care-Lauf vom 2026-07-13 Task `1165` unabhängig zertifiziert und geschlossen: Rund 70 Runtime-, Agenten-, Connector-, GUI- und Service-Flächen beziehen die Live-Datenbank jetzt über `hub.bach_paths`; die zentrale Regression verhindert neue Eigenkonstruktionen und hält die verbleibende Altschuld explizit schrumpfend. Die fokussierte Suite endete mit `61 passed`; `test-agent`-Doctor/Start-Dry-Run und Usecase `50` blieben ebenfalls grün. Der Upgrade-Check erkennt korrekt, dass `v3.13.0-bluesky` noch nicht im Distributionskatalog registriert ist (`repair_recommended=true`); die Versiegelung bleibt bis zur Bereinigung des Manifests und seiner privacy-sensitiven historischen Pfade zurückgestellt. Nächste DB-Pfad-Slices sind die expliziten Fallback-, Transitquellen-, Importzeit-Konstanten- und Testisolationsaufgaben `1166–1171`.
