...
Stand 2026-05-11: Die Releases-Seite von OpenClaw markiert `2026.5.7` als latest stable, die sichtbare Beta-Linie steht bei `2026.5.10-beta.3`, und im offiziellen GHCR-Paket liegt aktuell `2026.5.10-beta.2-slim` als jüngster Container-Tag. Für BACH bleibt OpenClaw vor allem als Vergleichssystem für Plugin-Sicherheit, Laufzeitdiagnostik und Operator-Steuerung relevant. BACH deckt bereits manifest-first Plugin-Metadaten, fail-closed Setup-Guards für Shell/Desktop/MCP-Flächen, Scans mit Quarantäne vor der Installation von Skills/MCP-Servern/Plugins, Memory-/Wiki-Provenance-Ansichten, maschinenlesbare Agent-/Scheduler-Statusflächen sowie workspace-scoped Cache-Invalidierung in der Agent-Runtime ab. Neu hinzugekommen sind stabilere Windows-Agenten-PIDs und maschinenlesbare `available_actions`-/`runtime_seconds`-Felder für Agenten- und Scheduler-Flächen. Nächste Schritte: Active-Run-Steering, Telemetrie, strengere Auth-Gates und externe Observability.
