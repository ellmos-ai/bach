...
Stand 2026-06-23: Auf der OpenClaw-Releases-Seite bleibt `2026.6.9` als aktuelle Stable-Linie markiert. Das neueste sichtbare Prerelease ist `2026.6.10-beta.2`, veröffentlicht am 2026-06-22 um 09:36 UTC. Für BACH sind daraus vor allem automatischer Fast-Mode für kurze Turns, robustere Modell-Routen, sicherere Session-/Channel-Zustände, erhaltene Trusted Policies bei Hook-Komposition, reichhaltigere Telegram-/Slack-/Discord-Zustellung, robustere Agent-/Session-Recovery, stärkere Codex-Freigabe- und Plugin-Pfade, explizite Such-/Skill-Herkunft sowie sicherere Release-/Netzgrenzen relevant. Quelle: [openclaw/openclaw releases](https://github.com/openclaw/openclaw/releases).
