...
- **OpenClaw-Abgleich und Release-Planung aktualisiert:** README, README.de, ROADMAP und `NEXT_RELEASE` spiegeln jetzt Stable `2026.6.1` vom 3. Juni 2026, das neueste sichtbare Prerelease `2026.6.5-beta.1` vom 6. Juni 2026 sowie den heutigen QA-Befund.
