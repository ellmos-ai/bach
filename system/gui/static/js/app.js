...
const ALL_PAGES = [
    ...
    { href: '/tasks-board', label: 'Tasks Board' },
    ...
    { href: '/agents/persoenlich', label: 'Persönlich — Alltag' },
    { href: '/agents/foerderplaner', label: 'Förderplaner — Förderung' },
    ...
    { href: '/tokens', label: 'Token-Nutzung' },
    { href: '/workflow-tuev', label: 'Workflow-TÜV' },
    { href: '/anonymization', label: 'Anonymisierung' },
